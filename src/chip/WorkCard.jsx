        ...
        return (
          ...
          >
            <POPUP className="media-content relative">
              <div className="h-[280px] w-[100%] max-w-[500px] hover:scale-125 transition duration-500 cursor-pointer shadow-xl rounded-md overflow-hidden sm:h-[260px] sm:w-[92%] sm:bg-cover mx-auto">
                {data.video ? (
                  <video
                    src={data.video}
                    alt={data.title}
